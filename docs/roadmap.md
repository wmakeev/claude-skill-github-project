...
Both skills should share the bot config and project pointer — that's exactly what `~/.claude/github-bot/config.json` and `claude-project.json` are for. They are skill-independent state.
